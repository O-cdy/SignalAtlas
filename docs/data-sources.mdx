...
| `signalatlas` | `disaster-news` | ReliefWeb Disasters; GDACS Alerts; NASA Earth Observatory; Guardian Environment; Disaster News; Humanitarian Alerts |
| `signalatlas` | `outage-news` | Power Outage News; Infrastructure Disruptions; Internet Outage News; Cloud Outages |
| `signalatlas` | `crisis` | CrisisWatch; IAEA; WHO; UNHCR |
