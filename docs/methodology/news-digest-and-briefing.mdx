...
| `energy` | Energy infrastructure, markets, shortages, chokepoints, and disruption streams. |
| `signalatlas` | Disaster, wildfire, outage, crisis, and humanitarian alert streams for the SignalAtlas deployment. |
