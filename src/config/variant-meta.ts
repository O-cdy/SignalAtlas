...
export const VARIANT_META: { full: VariantMeta; [k: string]: VariantMeta } = {
  ...
  signalatlas: {
    ...
    keywords: 'SignalAtlas, disaster monitor, earthquake tracker, wildfire map, natural disasters, power outage news, internet outage monitor, emergency alerts, crisis dashboard, climate disaster news, AI disaster summary',
    url: 'https://signalatlas.worldmonitor.app/dashboard',
    siteName: 'SignalAtlas',
    shortName: 'SignalAtlas',
    subject: 'Global Disaster, Wildfire, Earthquake, and Outage Monitoring',
    classification: 'Disaster Dashboard, Outage Monitor, AI News Aggregator',
    categories: ['news', 'productivity'],
    features: [
      'Earthquake tracking',
      'Natural disaster monitoring',
      'Wildfire intelligence',
      'Internet disruption tracking',
      'Power outage news',
      'Disaster news aggregation',
      'AI disaster summaries',
      'Source health and degradation signals',
    ],
  },
};
